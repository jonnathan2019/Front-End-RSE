...
//Botones
function siguiente() {
    window.location.href = `${url_global_pagina}tema_5${extencion}?usuario=${usuario_ID}&temas=${lista_temas}`;

}

function atras(){
    window.location.href = `${url_global_pagina}tema_3${extencion}?usuario=${usuario_ID}&temas=${lista_temas}`;
}
