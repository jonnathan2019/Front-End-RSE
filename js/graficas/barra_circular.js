...
(async function () {
    ...
    setTimeout(() => {
        ...
        valor_total()//para la barra de progreso circular TOTAL
        valor_dim_social()//barra de progreso circular SOCIAL
        valor_dim_ambental()//barra de progreso circular AMBIENTAL
