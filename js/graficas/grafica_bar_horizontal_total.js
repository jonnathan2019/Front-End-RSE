...
(async function () {
  ...
  setTimeout(() => {
    ...
    function graficar_barra_horizontal(variable, valor){
      var data = [
      ...
      var margin_bar_hori = { top: 20, right: 20, bottom: 20, left: 40 },
        width_bar_hori = 500 - margin_bar_hori.left - margin_bar_hori.right,
        height_bar_hori = 100 - margin_bar_hori.top - margin_bar_hori.bottom;
      ...
      var svg = d3.select(variable).append("svg")
        .attr("width", 300)//width_bar_hori + margin_bar_hori.left + margin_bar_hori.right
    ...
    graficar_barra_horizontal('.chart-container-espcifico',resutaldo_final)
    graficar_barra_horizontal('.chart-container-global',respuesta_final_2)
  ...
  setTimeout(() => {
    ...
    // append a 'group' element to 'svg'
    // moves the 'group' element to the top left margin_bar_hori
    var svg = d3.select(".chart-container-pdf").append("svg")
      .attr("width", 300)//width_bar_hori + margin_bar_hori.left + margin_bar_hori.right
      .attr("height", height_bar_hori + margin_bar_hori.top + margin_bar_hori.bottom)
      .append("g")
  ...
  z`
    ...
    svg.append("line")
      .attr("class", "avgValue")
      .attr("x1", resutaldo_final * (width_bar_hori / 2))
      .attr("y1", "0")
      .attr("x2", resutaldo_final * (width_bar_hori / 2))
      .attr("y2", height_bar_hori)
      .attr("stroke", "purple")
      .attr("stroke-width", "1")
      .style("stroke-dasharray", ("10,4"))
