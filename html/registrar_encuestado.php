        ...
        <div class="decripcion">
            <div class="decripcion-full">
                ...
                <div class="descripcion-contenido">
                    <span>
                        Usa nuestro sistema para conocer el estado de RSE de tu empresa,
                ...
                <div class="imagen-pix">
                    <svg id="26e08365-e7f3-4f87-b2fd-e29738693ebb" data-name="Layer 1"
                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="300"
                        height="300" viewBox="0 0 999 797.25">
                        <defs>
                            <linearGradient id="c24143ca-a0c1-48a5-a3b5-0343775bf348" x1="778.67" y1="845.35"
                                x2="778.67" y2="329.26" gradientUnits="userSpaceOnUse">
                        ...
                        <path
                            ...
                            transform="translate(-100.5 -51.37)" fill="#4747f1" opacity="0.1" />
                        <circle cx="174.08" cy="129.4" r="31.5" fill="#4747f1" opacity="0.1" />
                        <circle cx="108.09" cy="54.4" r="19.5" fill="#4747f1" opacity="0.1" />
                        <circle cx="925.57" cy="114.4" r="12" fill="#4747f1" opacity="0.1" />
                        <ellipse cx="689.92" cy="788.85" rx="84.24" ry="8.4" fill="#4747f1" opacity="0.1" />
                        <polygon
                        ...
                        <polygon
                            ...
                            fill="#5f5d7e" />
                        <rect x="978.67" y="485.19" width="20.33" height="242.78" opacity="0.1" />
                        <polygon
                            ...
                            opacity="0.1" />
                        <polygon points="999 477.64 999 496.5 0 507.64 0 483.64 94 464.64 912 458.64 999 477.64"
                            fill="#5f5d7e" />
                        <polygon points="999 477.64 999 496.5 0 507.64 0 483.64 999 477.64" opacity="0.1" />
                        <rect x="365.5" y="194.97" width="349.92" height="271.69" rx="22.82" ry="22.82"
                            fill="#474157" />
                        <rect x="393.66" y="219.48" width="294.12" height="221.63" fill="#ededf4" />
                        <circle cx="382.18" cy="330.29" r="4.82" fill="#e6e8ec" />
                        ...
                        <path
                            ...
                            transform="translate(-100.5 -51.37)" fill="#4747f1" />
                        <path
                            ...
                            transform="translate(-100.5 -51.37)" fill="url(#c24143ca-a0c1-48a5-a3b5-0343775bf348)" />
                        <path
                            ...
                            transform="translate(-100.5 -51.37)" opacity="0.1" />
                        <path
                            d="M812.43,770l-4,13-17,14.75-25,7.18s-11.75-6.43-7.75-7.68c1.11-.35,2.43-1.62,3.77-3.28a50,50,0,0,0,3.34-4.82c2.14-3.44,4.46-6.76,6.83-10a36,36,0,0,0,6.31-16.61c1.75-13.75-16-41.5-16-41.5l-32.25-66.25,45,5.5s24.25,83.25,24.25,87.25c0,3,6.84,13.85,10.4,19.32C811.58,768.77,812.43,770,812.43,770Z"
                            transform="translate(-100.5 -51.37)" fill="#fdc2cc" />
                        ...
                        <path
                            d="M820.43,786a4.8,4.8,0,0,1-1.5,2.07c-6.18,5.67-29.29,14.1-43.57,18.68A101.11,101.11,0,0,1,763.93,810c-3.5.25-10.75-2-15.75-5.07s-.5-7.43,1.52-9.68,14-2.92,14-2.92c-5.75,9.57,8.49,1.17,8.49,1.17s28.75-20.5,31.75-22.75,8.5-3.5,8.5-3.5Z"
                            transform="translate(-100.5 -51.37)" opacity="0.3" />
                        <path
                            d="M818.93,788.09c-6.18,5.67-29.29,14.1-43.57,18.68C788.3,795.81,810,790.08,818.93,788.09Z"
                            transform="translate(-100.5 -51.37)" opacity="0.1" />
                        <ellipse cx="686.97" cy="763.14" rx="17.03" ry="4.91" opacity="0.1" />
                        <rect x="677.5" y="633.64" width="17.5" height="129.5" fill="#5f5d7e" />
                        <path d="M795.5,691.43v15c-3.5-1.08-11.49-5.63-17.5-9.21V685h3.65Z"
                            transform="translate(-100.5 -51.37)" opacity="0.1" />
                        <path
                            ...
                            transform="translate(-100.5 -51.37)" fill="#474157" />
                        <path
                            d="M754.27,628.63s57.78-14.87,72.16-26,70.85,41.24,63.39,61-34.62,34.07-34.62,34.07-75.11,12.22-87.9-13.27S754.27,628.63,754.27,628.63Z"
                            transform="translate(-100.5 -51.37)" opacity="0.1" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-100.5 -51.37)" fill="#fdc2cc" />
                        <path d="M747.93,601.77s-17.41,3.75-15.2,9.25,11.95,5.75,11.95,5.75Z"
                            transform="translate(-100.5 -51.37)" fill="#fdc2cc" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-100.5 -51.37)" fill="#4747f1" />
                        <path
                            d="M746.45,806.38a.59.59,0,0,1,0,.14c-1,4.75-17.5,11.25-17.5,11.25s-10.5,1.75-16.5,3.25a4.15,4.15,0,0,1-1.41.13c-4.63-.35-4.84-9.26-4.84-10.63s5.75-7.75,7.5-8.75a53,53,0,0,0,5.64-5.41,50.57,50.57,0,0,1,17.86-12l.28-.11S747.25,801.45,746.45,806.38Z"
                            transform="translate(-100.5 -51.37)" opacity="0.3" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-100.5 -51.37)" fill="#4747f1" />
                        <path d="M735.68,622c-1,.75-12.25,24-4,30.5S735.68,622,735.68,622Z"
                            transform="translate(-100.5 -51.37)" opacity="0.1" />
                        <path d="M743.68,625.27c.25.75,23.5,37.75,36.25,40.75Z" transform="translate(-100.5 -51.37)"
                            opacity="0.1" />
                        <path d="M799.69,332.48l-3.72.79a25.07,25.07,0,0,1,3.14-.93Z"
                            transform="translate(-100.5 -51.37)" opacity="0.1" />
                        <path
                            ...
                            transform="translate(-100.5 -51.37)" opacity="0.1" />
                        <path d="M868,520.72c-.22,0-.43-.05-.64-.09A1.33,1.33,0,0,1,868,520.72Z"
                            transform="translate(-100.5 -51.37)" opacity="0.1" />
                        <path
                        ...
                        <path
                            d="M790.68,331.49a86,86,0,0,0-19.08-2.23c-2.09,0-4.33.11-6,1.26-2.21,1.55-2.49,4.35-3.15,6.77a18.78,18.78,0,0,1-7.15,10c-2.37,1.73-5.16,3-7.43,4.82s-4,4.52-3.43,7.18S748,364,751,364.85s6.19,1,9.21,1.82c9.59,2.49,16.1,12,14.16,20.65-1,4.31-3.73,8.39-3.31,12.77.49,5.23,5.32,9.26,7.59,14.11,2.07,4.42,1.93,9.38,1.77,14.16l-.61,17.54c-.16,4.62.24,10.18,4.8,12.44,2.44,1.2,5.48,1.07,8,2.13,4.94,2.06,6.24,7.67,6.64,12.49a129.1,129.1,0,0,1,.08,20.53c-.23,3-.39,6.35,2,8.45a10.72,10.72,0,0,0,4,1.94,59.32,59.32,0,0,0,15.42,2.64c4.2.16,8.64-.08,12.33,1.7,2.87,1.39,4.87,3.83,7.1,5.94a39.24,39.24,0,0,0,23.18,10.15c1.85.16,3.95.12,5.24-1.07s.53-3.76-1.31-3.61a8.89,8.89,0,0,0,8.42-3.22,7.1,7.1,0,0,0,0-8.17c-2.09-3-6.53-5-6.77-8.56-.13-2,1.2-3.81,2.24-5.59a23.51,23.51,0,0,0-3.64-28c-4.69-4.85-11.72-8.53-13.36-14.75-1.09-4.16.56-8.53-.07-12.76-1-7-7.93-12-11.74-18.24s-4.48-13.79-3.51-20.89,3.43-14,5.43-20.9c1.49-5.15,2.72-10.62,1.06-15.73-1.19-3.63-3.75-6.78-6.41-9.75-6.37-7.11-13.7-13.77-22.76-18s-20.1-5.87-29.72-2.74"
                            transform="translate(-100.5 -51.37)" opacity="0.1" />
                        <path d="M737.18,554.27s8.5,3.25,17.5-5.75S737.18,554.27,737.18,554.27Z"
                            transform="translate(-100.5 -51.37)" opacity="0.1" />
                        <g opacity="0.1">
                            <path d="M794.44,331.34a35.56,35.56,0,0,1,5-.63,37.93,37.93,0,0,0-7,.22Z"
                        ...
                        <path d="M689.43,484s-8,7.34-6.83,10.34S689.43,484,689.43,484Z"
                            transform="translate(-100.5 -51.37)" opacity="0.1" />
                        <path
                            ...
                            transform="translate(-100.5 -51.37)" fill="#474157" />
                        <path
                            d="M696.85,578.52c-5.77-1.41-21.68-2.71-29.25,22.69a112.32,112.32,0,0,1-6.71,17.17c-7.26,14.9-16.64,45.56,24.61,52.31l99,22.5s53,6.5,56.5,4,3-8,3-8-58.5,0-70-18-12-42.5-12-42.5,1.44-37.83-59-48.82C701,579.49,698.9,579,696.85,578.52Z"
                            transform="translate(-100.5 -51.37)" opacity="0.1" />
                        <path
                            ...
                            transform="translate(-100.5 -51.37)" fill="#474157" />
                        <path
                            d="M904.38,561.24c-1.14-7-7.8-12.06-15.45-11.93-14.24.24-58.07,2-78.43,14.27,0,0-15.5,9.23-20,9.23s-65.5,48,25,90.93c0,0,48.5,12.74,67.5-17.17,0,0,13.5-32.13,12.5-43.25s9-41.12,9-41.12S904.48,561.84,904.38,561.24Z"
                            transform="translate(-100.5 -51.37)" opacity="0.1" />
                        <rect x="739.5" y="612.14" width="16" height="34.07" fill="#5f5d7e" />
                        <ellipse cx="170.24" cy="470.71" rx="45.04" ry="2.89" opacity="0.1" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-100.5 -51.37)" fill="#4747f1" />
                        <rect x="150.3" y="458.44" width="43.81" height="11.52" fill="#474157" />
                        <rect x="143.34" y="421" width="57.24" height="40.2" fill="#474157" />
                        <rect x="149.88" y="458.44" width="43.81" height="11.52" opacity="0.1" />
                        <rect x="143.16" y="421.01" width="57.24" height="40.2" opacity="0.1" />
                        <rect x="153.18" y="458.44" width="43.81" height="11.52" fill="#474157" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-100.5 -51.37)" opacity="0.1" />
                        <path d="M257.76,474.65s12.84-46,30.85-31.8-7.33,36-7.33,36Z"
                            transform="translate(-100.5 -51.37)" fill="#4747f1" />
                        <circle cx="163.74" cy="372.87" r="1.44" opacity="0.1" />
                        <circle cx="163.62" cy="379.6" r="1.44" opacity="0.1" />
                        <circle cx="205.39" cy="374.19" r="1.44" opacity="0.1" />
                        <circle cx="171.78" cy="408.64" r="1.44" opacity="0.1" />
                        <circle cx="202.39" cy="385.36" r="1.44" opacity="0.1" />
                        <circle cx="187.51" cy="400.24" r="1.44" opacity="0.1" />
                        <circle cx="168.66" cy="375.75" r="1.44" opacity="0.1" />
                        <circle cx="201.43" cy="378.52" r="1.44" opacity="0.1" />
                        <circle cx="196.51" cy="389.68" r="1.44" opacity="0.1" />
                        <circle cx="181.38" cy="407.56" r="1.44" opacity="0.1" />
                        <circle cx="178.26" cy="400.48" r="1.44" opacity="0.1" />
                        <circle cx="170.82" cy="384.52" r="1.44" opacity="0.1" />
                        <rect x="153.18" y="458.44" width="43.81" height="4.21" opacity="0.1" />
                        <rect x="146.22" y="421" width="57.24" height="40.2" fill="#474157" />
                        <circle cx="183.3" cy="414.04" r="1.44" opacity="0.1" />
                        <circle cx="174.66" cy="415.84" r="1.44" opacity="0.1" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-100.5 -51.37)" fill="#ffd037" />
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-100.5 -51.37)" fill="#ffd037" />
                        <ellipse cx="293.04" cy="692.74" rx="74.6" ry="11.45" fill="#4747f1" opacity="0.1" />
                        <path
                            ...
                            transform="translate(-100.5 -51.37)" fill="#65617d" />
                        <polygon points="331.08 623.15 330.58 627.26 255.51 627.26 255.01 623.15 331.08 623.15"
                            fill="#9d9cb5" />
                        <polygon points="330.38 628.98 329.88 633.1 256.22 633.1 255.71 628.98 330.38 628.98"
                            fill="#9d9cb5" />
                        <polygon points="329.66 634.81 329.16 638.93 256.93 638.93 256.43 634.81 329.66 634.81"
                            fill="#9d9cb5" />
                    </svg>
                </div>
            </div>
            ...
            <div class="container-ingresar-datos">
                ...
                <div class="iniciar-datos">
                    ...
                    <div class="row-telefono">
                        <label class="mb-1">
                            <span class="mb-0">Telefono</span>
                        </label>
                        <div class="ingresar-telefono">
                            <i class="fa fa-phone-square"></i>
                            <input class="datos" type="text" id="telelfono" placeholder="Ingrese su Telefono">
                        </div>
                    </div>
                    -->
                    <!--trabajo-->
                    <!-- <div class="row-trabajo">
                        <label class="mb-1">
                            <span class="mb-0">Trabajo</span>
                        </label>
                        <div class="ingresar-trabajo">
                            <i class="fa fa-black-tie"></i>
                            <select id="job">
                                <option value="">Elije tu trabajo</option>
                                <option value="Desarrollador" id="trabajo">Desarrollador</option>
                                <option value="Gerente" id="trabajo">Gerente</option>
                                <option value="Contable" id="trabajo">Contable</option>
                                <option value="otro" id="trabajo">Otro</option>
                            </select>
                        </div>
                    </div> -->
                    <!--contrasena-->
...
<script type="module">
    ...
    function validar_contrasena(contrasena) {
        if (contrasena.length >= 6) {
            return 1; // contrasena validad
        } else {
            return 0; // contrasena INVALIDAD
        }
    }
    ...
    // Guardar Info en FIREBASE
    async function set_firebase(email, contrasena) {
    ...
    registrar_encuestado.addEventListener("click", (e) => {
        ...
        // validamos que la contrasena se al menos 6 caracteres 
        let val_contrasena = validar_contrasena(contrasena);
